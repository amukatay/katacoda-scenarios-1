...
# это выражение создает в выходном объекте атрибут allow со значением в виде массива, 
# содержание элемента массива определяется переменной msg
allow[msg] {
	# input[suite] - итератор по ключам входного объекта, на каждой итерации 
    # переменной suite присваивается значение ключа соответствующего объекта
	input[suite]
